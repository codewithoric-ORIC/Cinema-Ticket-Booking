        ...
        return (
            <div className="w-full min-h-screen bg-slate-100 flex items-center justify-center">
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-slate-800 mb-4">No Booking Selected!</h2>
                    <Link to="/movies" className="text-purple-600 font-bold hover:underline">Browse Movies</Link>
                </div>
            </div>
        );
    }
            ...
            <div className="w-full min-h-screen bg-slate-100 overflow-x-hidden relative pt-24 pb-20">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6">
                    <div className="w-full rounded-[2.5rem] bg-white/40 backdrop-blur-2xl p-12 text-center">
                        ...
                        <h1 className="text-3xl font-black text-slate-800 tracking-tight mb-4">Payment Successful!</h1>
                        <p className="text-slate-500 text-sm font-medium mb-8">Your tickets have been booked successfully! 🎉</p>
                        ...
                        <div className="bg-white/60 backdrop-blur-xl border border-white/80 rounded-[2rem] p-8 mx-auto max-w-md">
                            ...
                            <div className="space-y-3 text-left">
                                ...
                                <div className="flex justify-between text-sm pt-3 border-t border-slate-200">
                                    ...
                                    <span className="text-purple-600 font-black text-lg">{totalPrice.toLocaleString()} MMK</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Link
                                to="/"
                                className="group relative h-12 px-8 rounded-full text-sm font-bold text-slate-700
                            ...
                            >
                                ...
                                <span className="relative z-10">Book More Tickets</span>
                            </Link>
                        </div>
                    </div>
                </div>
        ...
        <div className="w-full min-h-screen bg-slate-100 overflow-x-hidden relative pt-24 pb-20">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6">
                <div className="flex items-center gap-4 mb-8">
                    <Link to={-1 as any} className="flex items-center gap-2 text-slate-500 hover:text-purple-600 font-bold text-sm transition-colors cursor-pointer group">
                ...
                <div className="mb-8 space-y-2">
                    <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-purple-600/[0.08] border border-purple-500/20 shadow-sm backdrop-blur-md">
                        <span className="text-xs font-bold uppercase tracking-widest text-purple-700">Checkout</span>
                    </div>
                ...
                <div className="mb-8 bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-200 rounded-[2rem] p-6 backdrop-blur-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <span className="text-slate-800 font-bold ml-2">{TEST_DATA.cardNumber}</span>
                        </div>
                        <div>
                            <span className="text-slate-500 font-semibold">Expiry:</span>
                            <span className="text-slate-800 font-bold ml-2">{TEST_DATA.cardExpiry}</span>
                        </div>
                        <div>
                            <span className="text-slate-500 font-semibold">CVV:</span>
                            <span className="text-slate-800 font-bold ml-2">{TEST_DATA.cardCvv}</span>
                        </div>
                        <div>
                            <span className="text-slate-500 font-semibold">Any other data:</span>
                            <span className="text-slate-800 font-bold ml-2">Already filled!</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        <div className="bg-white/40 backdrop-blur-2xl border border-white/80 rounded-[2.5rem] p-6">
                            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-6">Booking Summary</h3>
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between items-center text-sm mb-3">
                                    <span className="font-semibold text-slate-500">Selected Seats</span>
                                    <span className="font-extrabold text-slate-800">{seats.join(", ")}</span>
                                </div>
                                <div className="flex justify-between items-center text-sm mb-3">
                                    <span className="font-semibold text-slate-500">Total Tickets</span>
                                    <span className="font-extrabold text-slate-800">{seats.length} Tickets</span>
                                </div>
                                <div className="flex justify-between items-center text-sm pt-4 border-t border-slate-200/60">
                                    ...
                                    <span className="text-2xl font-black text-purple-600">{totalPrice.toLocaleString()} MMK</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-7">
                        <form onSubmit={handlePayment} className="bg-white/40 backdrop-blur-2xl border border-white/80 rounded-[2.5rem] p-6 space-y-8">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold uppercase tracking-wider text-slate-500 ml-4">Name</label>
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold uppercase tracking-wider text-slate-500 ml-4">Email</label>
                                        <div className="relative flex items-center group">
                                            <input
                                                type="email"
                                                name="email"
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold uppercase tracking-wider text-slate-500 ml-4">Card Number</label>
                                        <div className="relative flex items-center group">
                                            <input
                                                type="text"
                                                name="cardNumber"
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="flex flex-col gap-1.5">
                                            <label className="text-xs font-bold uppercase tracking-wider text-slate-500 ml-4">Expiry Date</label>
                                            <input
                                                type="text"
                                                name="cardExpiry"
                                        ...
                                        <div className="flex flex-col gap-1.5">
                                            <label className="text-xs font-bold uppercase tracking-wider text-slate-500 ml-4">CVV</label>
                                            <input
                                                type="text"
                                                name="cardCvv"
                                    ...
                                    <div className="flex items-center gap-2 ml-4 my-1">
                                        ...
                                        />
                                        <label htmlFor="saveCard" className="text-xs font-semibold text-slate-600 select-none cursor-pointer">
